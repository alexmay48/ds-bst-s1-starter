package com.learn.spellchecker;
...
public class SpellChecker {
	...
	private void buildDictionary(List<String> words) {
		...
		System.out.println("Height of left " + dictionary.height(dictionary.root.left));
		System.out.println("Height of right " + dictionary.height(dictionary.root.right));
	}
