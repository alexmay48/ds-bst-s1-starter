...
public class SpellCheckerDemo {
	...
	public static void main(String[] args) {
		...
		SpellChecker mySC = new SpellChecker(new File("src/main/resources/dictionary.txt"));

		run_spell_check(mySC, "src/main/resources/hello_world.txt");
		run_spell_check(mySC, "src/main/resources/good_luck.txt");
	}
